...
class AppShopFragmentRecyclerViewAdapter(val context: Context, private val mutableList: MutableList<String>): RecyclerView.Adapter<AppShopFragmentRecyclerViewAdapter.MyViewHolder>() {
